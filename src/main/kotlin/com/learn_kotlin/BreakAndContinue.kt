fun main() {
    ...
    // Pada kode diatas, break yang sudah ditandai dengan label akan dilompati ke titik awal proses perulangan
    // yang sudah ditandai dengan label. break akan menghentikan proses perulangan terluar dari dalam
